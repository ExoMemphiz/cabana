...
function longSignal(options: { index: number; unsigned?: boolean; factor?: number }) {
	return {
		...options,
		size: 32,
...
function shortSignal(options: { index: number; unsigned?: boolean; factor?: number }) {
	return {
		...options,
		size: 16,
...
function charSignal(options: { index: number; unsigned?: boolean }) {
	return {
		...options,
		size: 8,
...
function boolSignal(options: { index: number }) {
	return {
		...options,
		size: 1,
...
export function addressForName(name: string) {
...
export function frameForAddress(address: number) {
